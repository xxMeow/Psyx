$(document).ready(function() {
    function refresh_list() {
        $.ajax({
            ...
            method: "GET",
            dataType: "json",
            success: function(data) { // clear old rows, rerender the pack list, do not alert anything
                ...
                // render new rows from received data
    ...
    $("#pack_list").on("click", ".download_btn", function() {
        ...
        $.ajax({
            url: "/api/admin/download?id=" + p_id,
            method: "GET",
            dataType: "json",
